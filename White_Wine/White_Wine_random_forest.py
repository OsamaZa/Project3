...
l_estimators = [10,50,100,200,500] # List with the number of decision trees to be combined
...
confusion_matrices = np.zeros((len(l_estimators),len(l_maxfeatures),7,7)) # Making matrix to the confusion matrices
