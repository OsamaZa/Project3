...
X = ColumnTransformer([("",onehotencoder,[0,1,2,3,4,5,6,7,8]),],remainder="passthrough").fit_transform(X)
y = np.ravel(y)
...
def SVM(c,kernel,degree,gamma,X,y):
